                                    ...
                                    <tbody>
                                    	<c:forEach items="${listeClients}" var="client">
	                                        <tr>
	                                            ...
	                                            <td><a href="consulterClient?codeClient=${client.codeClient}">${client.prenomClient}</a></td>
	                                            <td><a href="consulterClient?codeClient=${client.codeClient}">${client.nomClient}</a></td>
