	                ...
	                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
		                <div class="card">
		                	<div class="body">
		                		<div class="row clearfix">
	                                <div class="col-sm-9">
	                                	<h3>${employe.prenomEmploye} ${employe.nomEmploye}</h3>
	                                	<ul>
	                                		<li><b>Code Employe: </b> ${employe.codeEmploye}</li>
	                                		<li>
	                                			<b>Supérieur: </b>
	                                			<c:choose>
	                                				<c:when test="${empty employe.superieurHierarchique}">Aucun</c:when>
	                                				<c:otherwise>${employe.superieurHierarchique.prenomEmploye} ${employe.superieurHierarchique.nomEmploye}</c:otherwise>
	                                			</c:choose>
	                                		</li>
	                                	</ul>
	                                </div>
