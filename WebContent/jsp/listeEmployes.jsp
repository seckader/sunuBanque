...
<html>
    ...
    <link href="<%= request.getContextPath() %>/template/css/themes/all-themes.css" rel="stylesheet" />
    	...
    	<link href="<%= request.getContextPath() %>/template/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css" rel="stylesheet">
	</head>
                                    ...
                                    <tbody>
                                    	<c:forEach items="${listeEmployes}" var="employe">
	                                        <tr>
	                                            ...
	                                            <td><a href="consulterEmploye?codeEmploye=${employe.codeEmploye}">${employe.prenomEmploye}</a></td>
	                                            <td><a href="consulterEmploye?codeEmploye=${employe.codeEmploye}">${employe.nomEmploye}</a></td>
	                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
