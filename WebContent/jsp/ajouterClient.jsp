	                ...
	                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		                <div class="card">
		                	<div class="body">
		                		<div class="row clearfix">
	                                <div class="col-sm-12">
	                                	<form method="post" action="<%= request.getContextPath() %>/ajouterClient">
	                                    	...
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="text" name="prenomClient" class="form-control" placeholder="Prénom" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
	                                    	...
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="text" name="numeroCompte" class="form-control" placeholder="Numero Compte" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
												<div class="form-line">
													<h2 class="card-inside-title">Type Compte</h2>
	                                    	...
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                        	<h2 class="card-inside-title">Solde d'ouverture</h2>
		                                            <input type="number" name="solde" class="form-control" placeholder="Solde" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="number" name="decouvert" class="form-control" placeholder="Decouvert (Compte Courant)" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="number" name="taux" class="form-control" placeholder="Taux rénumération (Compte Epargne)" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
