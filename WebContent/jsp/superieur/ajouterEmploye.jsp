	                ...
	                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		                <div class="card">
		                	<div class="body">
		                		<div class="row clearfix">
	                                <div class="col-sm-12">
	                                	<form method="post" action="<%= request.getContextPath() %>/ajouterEmploye">
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="text" name="nomEmploye" class="form-control" placeholder="Nom" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
		                                            <input type="text" name="prenomEmploye" class="form-control" placeholder="Prénom" />
		                                        </div>
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
		                                        <div class="form-line">
	                                    	...
	                                    	<div class="form-group form-group-lg">
												<div class="form-line">
													<h2 class="card-inside-title">Supérieur Hiérarchique</h2>
				                                    <select name="superieur">
				                                        <option value="0">-- Aucun --</option>
				                                        <c:forEach items="${listeEmployes}" var="employe">
				                                        	<option value="${employe.codeEmploye}">${employe.codeEmploye} - ${employe.prenomEmploye} ${employe.nomEmploye}</option>
				                                        </c:forEach>
				                                    </select>
				                                	</div>
	                                    	</div>
...
<!-- 				                                </div> -->
	                                    	...
	                                    	<div class="form-group form-group-lg demo-checkbox">
<!-- 		                                        <div class="demo-checkbox"> -->
													<h2 class="card-inside-title">Rôles attribués</h2>
													<c:forEach items="${listeRoles}" var="role">
					                                	<input type="checkbox" id="${role.idRole}" name="${role.nom}" value="${role.nom}" class="filled-in chk-col-green" />
						                                <label for="${role.idRole}">${role.nom}</label>
					                                </c:forEach>
<!-- 				                                </div> -->
	                                    	</div>
	                                    	<div class="form-group form-group-lg">
